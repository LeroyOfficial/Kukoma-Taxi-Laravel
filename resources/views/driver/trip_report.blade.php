...
<html>
<head>
    <title>{{$driver->first_name}} {{$driver->last_name}} - {{$type}} Trip Report - {{ $startDate->format('d M Y') }}</title>
    <style>
        table {
...
<body>
    <div style="text-align: center">
        ...
        <h3>{{$driver->first_name}} {{$driver->last_name}} - {{$type}} Trip History Report</h3>
        <h3>
    ...
    <table>
        <thead style="font-weight: bold">
            <tr>
                ...
                <th style="background-color:#ffc500">Userr</th>
